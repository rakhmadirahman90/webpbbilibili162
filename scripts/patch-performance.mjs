...
// Lazy global services are non-visual. They must never suspend the whole application.
...
console.log('[performance] public render unblocked, route chunks moved out of initial bundle, idle prefetch enabled, realtime services deferred');
