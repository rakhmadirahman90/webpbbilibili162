...
const marker = '/* __TOURNAMENT_ADMIN_FORM_TEXT_CONTRAST_V3__ */';
...
if (!src.includes(opening)) throw new Error('[patch-form-text-contrast] tournament admin opening tag not found');
