...
export default function Gallery() {
  ...
  const handleDetailBack = useCallback(() => {
    ...
    if (fromLanding) {
      ...
      // State detail TIDAK di-reset sebelum navigate karena efek URL dapat
      // menangkap perubahan tersebut dan membutuhkan klik kedua.
