...
export default function AdminRouteView({ session }: Props) {
  ...
  switch (path) {
    ...
    case 'tournament-manager':
      return adminOnly(AdminKelolaTurnamen);
    case 'pendaftaran-turnamen':
    ...
    case 'pendaftaran/seeded-peserta':
      return adminOnly(SeededTurnamen);
    case 'turnamen-liga':
    ...
    case 'rekap-keuangan':
    case 'laporan-iuran': return <AdminLaporanIuranAtlet isAdmin={isAdmin} session={session} />;
    ...
    case 'sejarah': return isAdmin ? render(AdminSejarah) : <div className="p-4 md:p-8"><PublicSejarah /></div>;
    case 'visi-misi': return isAdmin ? render(AdminVisiMisi) : <div className="p-4 md:p-8"><PublicVisiMisi /></div>;
    case 'fasilitas': return isAdmin ? render(AdminFasilitas) : <div className="p-4 md:p-8"><PublicFasilitas /></div>;
    case 'struktur': return isAdmin ? render(AdminStructure) : <div className="p-4 md:p-8"><PublicStructure /></div>;
    ...
    case 'sponsorship':
    case 'sponsor':
    case 'daftar-sponsorship': return adminOnly(AdminSponsorship);
