...
import AdminTournamentNav from './AdminTournamentNav';
  ...
  return <div className="h-[100dvh] min-h-0 flex bg-[#07101f] overflow-hidden">
    ...
    <div className="flex-1 flex flex-col min-w-0 min-h-0 h-[100dvh] overflow-hidden bg-[#07101f]">
      ...
      <main className="admin-main flex-1 min-w-0 min-h-0 overflow-y-auto overflow-x-hidden flex flex-col overscroll-contain">
        <AdminTournamentNav />
        <div className="min-w-0 flex-1 flex flex-col">{isDashboard ? children : <AdminRouteView session={{ user: { email } }}/>}</div>
      </main>
    </div>
  </div>;
}