...
export default function KasRealtimeNotifier() {
  useEffect(() => {
    ...
    const handlePayload = async (payload: any) => {
      ...
      const waText = buildWaText({ startDate: snapshotDate, endDate: snapshotDate, previous, income, expense, saldo, latestIncome, latestExpense });
